...
const ComponentElement = forwardRef((
    ...
    return (
        <div
            ...
            className="relative h-fit w-full mx-auto flex items-center justify-center my-20" >
            ...
            </div>
            {
                ...
                &&
                <div
                    className="absolute z-50 bg-gray-200 top-12 start-0 translate-x-[-50%] w-[400px] p-1 border text-sm rounded-xs py-4">
                    <div
                    ...
                    >
                        <div
                            ...
                            <HolismIcon
                                ...
                                className="fill-red-500 hover:bg-red-100 transition-all rounded-xs hover:scale-110" />
                        </div>
                        <input
                            type="text"
                        ...
                        <div
                            ...
                            <HolismIcon
                                icon={DoneIcon}
                                className={`${isChangedAttribute ? "fill-green-500 hover:bg-green-100 hover:scale-110 " : "fill-gray-100"}   transition-all rounded-xs `}
                            />
                    ...
                    <div className="flex gap-x-1 flex-col items-center gap-y-2">
                        ...
                        {attributes.map(({ id, name, value }) => <div
                            ...
                            <div className="w-1/2 flex items-center">
                                ...
                                <input
                                    type="text"
                                    className="border border-transparent outline-hidden focus:border-green-400 px-1 w-full rounded-xs"
                                    value={name}
