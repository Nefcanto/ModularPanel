        ...
        <div
            ...
            >
                ...
                {selected && focused && <input
                    className="absolute top-5 start-2 w-52 text-[18px] p-1 z-20 outline-hidden"
                    type="text"
                    placeholder="image alt"
                    value={alt}
                    onChange={handleAltChange}
                    onKeyDown={onPressTabButton}
                />}
                {selected && focused && <input
                    className="absolute top-16 start-2 w-52 text-[18px] p-1 z-20 outline-hidden"
                    type="text"
                    ref={titleRef}
